                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-right">{{__('dashboard.agents.intervention')}}</th>
                                <th class="text-right">{{__('dashboard.mission.start_time')}}</th>
                                <th class="text-right">{{__('dashboard.mission.ended_at')}}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{Helper::date_format_show('d/m/Y H:i:s',$result->ended_at)}}</td>
