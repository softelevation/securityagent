            ...
            <div class="col-md-4">
                <div class="shortLink">
                    ...
                    <ul>
                        ...
                        <li><a href="{{url('/general-terms-and-conditions')}}"><i class="fa fa-share" aria-hidden="true"></i>{{__('frontend.general-terms-and-conditions')}}</a></li>
                        <li><a href="{{url('/general-terms-of-use')}}"><i class="fa fa-share" aria-hidden="true"></i> {{__('frontend.general-terms-of-use')}}</a></li>
