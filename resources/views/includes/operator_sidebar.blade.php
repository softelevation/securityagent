                ...
                <div class="Left_tabs_panel border">
                    ...
                    <div class="tabs_menu">
                        <ul class="nav flex-column sidebar_nav" id="myTab" role="tablist">
							...
							<li class="nav-item">
                                <a class="nav-link" href="{{url('operator/message-center')}}"><i class="fa fa-comments"></i> {{__('dashboard.mission.message_center')}}  @if(Helper::get_message_center_count('operator') > 0)<span class="badge badge-primary badge-pill float-right orange_bg">{{Helper::get_message_center_count('operator')}}</span>@endif</a>
                            </li>
							<li class="nav-item">
