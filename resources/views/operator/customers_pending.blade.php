              ...
              <div class="tab-pane">
                <div class="border" id="myTabContent">
                  <ul class="nav nav-tabs">
                      ...
                      <li class="nav-item w-50">
                          <a class="nav-link">Verified Customers</a>
                      </li>
                  </ul>
                  <div>
                      <div>
                                  ...
                                  <tbody>
                                    @forelse($data as $customer)
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                            <a class="action_icons" href="{{url('operator/customers/pending/view/'.$en_id)}}"><i class="fas fa-eye text-grey" aria-hidden="true"></i> View details</a>
