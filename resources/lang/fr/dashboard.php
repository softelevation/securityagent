...
return [
	...
	'payment' => [
		...
		'bank_transfer_i_aggree' => "J'accepte de payer le montant total ci-dessus en effectuant un virement bancaire manuellement via ma banque directement avec rajoutant en référence le numéro de mission.",
